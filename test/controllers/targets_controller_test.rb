...
class TargetsControllerTest < ActionController::TestCase
  ...
  test "should create target" do
    assert_difference('Target.count') do
      post :create, target: { alert_age: @target.alert_age, contacts: @target.contacts, dob: @target.dob, gender: @target.gender, name: @target.name }
    end
  ...
  test "should update target" do
    patch :update, id: @target, target: { alert_age: @target.alert_age, contacts: @target.contacts, dob: @target.dob, gender: @target.gender, name: @target.name }
    assert_redirected_to target_path(assigns(:target))
  end
